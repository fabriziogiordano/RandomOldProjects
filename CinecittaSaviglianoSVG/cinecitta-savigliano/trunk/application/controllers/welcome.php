...
class Welcome extends Controller {
	...
	function index($i= NULL)
	{
		...
		if($this->template['films'])
		{
			...
			$this->template['metadescription'] = 'Multisala. I film questa settimana: '.preg_replace('/"/',' ',$this->Programmazioni->get_film_titles($this->template['programmazione']['id']));
		}
		else
		{
			$this->template['metatitle'] = 'Programmazione';
			$this->template['metadescription'] = 'Programmazione del Multisala Cinecittà Savigliano';
		}
		
		$this->template['content_view'] = 'welcome';
